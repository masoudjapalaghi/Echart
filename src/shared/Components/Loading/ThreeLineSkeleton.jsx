...
export const ThreeLineSkeleton = () => {
  const lgUp = useMediaQuery("lgUp");
  return (
    <>
      {lgUp ? (
          <div className="hidden lg:flex flex-col gap-8 w-full animate-pulse">
            ...
            <div className="flex  bg-white flex-wrap justify-evenly h-3 items-center px-4">
            ...
            <div className="flex  bg-white flex-wrap justify-evenly items-center h-3 px-4">
              <div className="w-full flex justify-evenly">
                <SqureSkeleton width="w-16" height="h-2" />
                <SqureSkeleton width="w-16" height="h-2" />
                <SqureSkeleton width="w-16" height="h-2" />
